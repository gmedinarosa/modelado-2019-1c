...
class ApproxChart extends React.Component {
    ...
    return (
      <ResponsiveContainer>
        <LineChart data={this.props.data} margin={{top: 5, right: 30, left: 20, bottom: 5}}>
          ...
          <XAxis dataKey="x" domain={[xAxis.min, xAxis.max]} scale={'linear'} type={'number'} allowDataOverflow={true}/>
